...
public class HelpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Link XML Components
        WebView kycWebView = findViewById(R.id.helpWebView);
        progressBar = findViewById(R.id.helpProgressBar);
        progressText = findViewById(R.id.helpProgressText);

        // Firebase initialization
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference();
        databaseReference = databaseReference.child("Links").child("helpLink");
        ...
        // fetch help url from database and load in webView
